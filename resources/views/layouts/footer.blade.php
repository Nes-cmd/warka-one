<footer class="container m-auto bg-transparent dark:bg-gray-900 px-3">
    <div class="mx-auto w-full py-6 lg:py-8">
            ...
            <div class="grid grid-cols-2 gap-8 sm:gap-6 ">
                ...
                <div>
                    ...
                    <ul class="text-gray-500 dark:text-gray-400 font-medium">
                        ...
                        <li>
                            <a href="{{ route('privacy-policy') }}" class="hover:underline">Terms &amp; Conditions</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="flex items-center justify-between">
            <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© {{ now()->year }} <a href="#" class="hover:underline">Ker Labs™</a>. All Rights Reserved.
            </span>
