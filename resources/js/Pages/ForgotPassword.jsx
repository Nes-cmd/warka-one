...
export default function ForgotPassword({ countries, selectedCountry: initialSelectedCountry, options: initialOptions }) {
    ...
    return (
        <GuestLayout title="Reset Password">
            <div className="text-center mb-8">
                ...
                <p className="text-gray-600 dark:text-gray-400">Enter your email or phone to receive a reset code</p>
            </div>

            <div className="mb-6 text-sm text-gray-600 dark:text-gray-400 text-center">
                Forgot your password? No problem. Just let us know your phone/email address and we will phone or email you a password reset code that will allow you to choose a new one.
            </div>
