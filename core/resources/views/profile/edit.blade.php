<x-app-layout>
    <main class="max-w-[1480px] mx-auto  md:mt-20 mb-20 mt-5 px-4  font-poppins">
        <section class="flex flex-col md:flex-row gap-5">
            <section class="md:w-1/2 w-full rounded-2xl bg-gray-100  p-5 flex flex-col ">
                ...
                <a href="/profileSettings" class=" w-40  self-end flex gap-3 font-poppins rounded-lg text-primary font-semibold ">
                    <img class="" src="{{ asset('assets/icons/vuesax/linear/magicpen.svg') }}" alt="" srcset="">
                    <span>
                        Edit Profile
                    </span>
                </a>
        ...
        <section class="flex flex-col md:flex-row gap-5 mt-10">
            <section class=" md:w-[50%] w-full  md:bg-gray-100 bg-transparent rounded-2xl flex flex-col py-4 md:px-4">
        ...
        <section class="md:w-[49%] w-full  md:bg-gray-100 bg-transparent rounded-2xl flex flex-col py-4 md:px-4 mt-10">
